...
class Protocols extends React.Component {
  componentDidMount() {
    this.props.dispatch(
      loadRouteserverProtocol(parseInt(this.props.routeserverId, 10))
    );
  }
  ...
  componentWillReceiveProps(nextProps) {
    if(this.props.routeserverId !== nextProps.routeserverId) {
      this.props.dispatch(
        loadRouteserverProtocol(parseInt(nextProps.routeserverId, 10))
      );
    }
  }
  ...
  render() {
    ...
    let protocol = this.props.protocols[parseInt(this.props.routeserverId, 10)];
    if(!protocol) {
      return null;
    }
